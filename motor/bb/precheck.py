...
def planning_diagnostics(data, extra=None):
    ...
    return dict(
        ...
        assignmentBuildMs=extra.get('assignmentBuildMs', extra.get('supportBuildMs', 0)),
        indexBuildMs=extra.get('indexBuildMs', 0),
        constraintBuildMs=extra.get('constraintBuildMs', 0),
        modelBuildTotalMs=extra.get('modelBuildTotalMs', 0),
        generatedShiftTemplatesBeforePruning=extra.get('generatedShiftTemplatesBeforePruning', extra.get('generatedShiftTemplates', 0)),
        generatedShiftTemplatesAfterPruning=extra.get('generatedShiftTemplatesAfterPruning', extra.get('generatedShiftTemplates', 0)),
        generatedShiftPrunedPercent=extra.get('generatedShiftPrunedPercent', 0),
        shiftVariablesBeforePruning=extra.get('shiftVariablesBeforePruning', extra.get('after', 0)),
        shiftVariablesAfterPruning=extra.get('shiftVariablesAfterPruning', extra.get('after', 0)),
        coverageTargetLocked=extra.get('coverageTargetLocked', False),
        costTargetLocked=extra.get('costTargetLocked', False),
        coverageIncumbentAvailable=extra.get('coverageIncumbentAvailable', False),
        costIncumbentAvailable=extra.get('costIncumbentAvailable', False),
        hintVariablesAppliedPerPhase=extra.get('hintVariablesAppliedPerPhase') or [],
