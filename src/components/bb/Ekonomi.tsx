  ...
  if (!d || !api.hasBer()) {
    return (
      <Card className="rounded-2xl p-8 text-center shadow-lift">
        ...
        <h2 className="mt-4 text-xl font-extrabold text-deep">Rätt resurs i rätt tid kan inte visas ännu</h2>
    ...
    <div className="space-y-4">
      <Card className="gap-0 rounded-2xl p-6 shadow-lift md:p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <Eyebrow>Rätt resurs i rätt tid · hela perioden</Eyebrow>
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <Tabell
          ...
          etikett="Rätt resurs i rätt tid"
