...
const FALT: [string, string, string][] = [
  ...
  ["Kontinuitet (kr per kund–medarbetar-par)", "continuitySek", "Vikt i motorns målfunktion. 50 är standard."],
  ["Spridning (kr per promille)", "spreadSekPerPermille", "Vikt för jämn belastning. 2,5 är standard."],
];
